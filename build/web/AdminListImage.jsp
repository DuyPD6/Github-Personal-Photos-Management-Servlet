<%-- 
    Document   : AdminListImage
    Created on : Jul 10, 2021, 1:33:35 PM
    Author     : bunny
--%>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <c:choose>
                                <c:when test="<%=s.getApproved() == 1%>">
                                    <td>Yes</td>
                                </c:when>    
                                <c:otherwise>
                                    <td><a class="btn btn-danger" onclick="return confirm('Do you want to allow this image to be public ?')"  href="approveImage?id=<%=s.getName()%>">No</a>
                                    </c:otherwise>
                                </c:choose>
